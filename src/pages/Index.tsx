...
const L = ({ href, children }: { href: string; children: React.ReactNode }) => (
  <a href={href} target="_blank" rel="noopener noreferrer" className="neon-text hover:underline">{children}</a>
);
const B = ({ children }: { children: React.ReactNode }) => <span className="font-semibold text-white">{children}</span>;

const OFFER_JSX = (
  <div className="text-xs text-muted-foreground leading-relaxed space-y-2 font-sans">
    <p><B>ОФЕРТА</B><br/>о заключении договора на оказание платных информационных услуг</p>
    <p><B>ПРЕАМБУЛА</B><br/><B>Порядок заключения Договора, стороны Договора</B></p>
    <p>В соответствии со ст. 435, п. 2 ст. 437 ГК РФ данный документ является публичной офертой, направляемой физическим лицом Поповым Алексеем Юрьевичем (ИНН 644101988643), зарегистрированным в качестве плательщика налога на профессиональный доход (далее – Исполнитель), в адрес неограниченного круга физических лиц, достигших 18-летнего возраста, о намерении заключить Договор на оказание платных информационных услуг на условиях, описанных далее (далее «Договор»).</p>
    <p>Сторонами Договора являются Исполнитель и правоспособное и дееспособное физическое лицо, обратившееся за заключением Договора в своих интересах или в интересах другого лица (далее «Заказчик»).</p>
    <p>Ознакомление Заказчика с офертой и приложениями к ней осуществляется путем размещения действующей ее редакции на сайте по адресу: <L href="https://radiology-arts.ru">https://radiology-arts.ru</L>.</p>
    <p>Внимательно ознакомьтесь с текстом настоящей оферты и приложениями к ней и, если вы не согласны с каким-либо условием, вам предлагается воздержаться от использования предлагаемых Услуг и Договор считается незаключенным.</p>
    <p>Полным и безоговорочным принятием (Акцептом) условий настоящей Оферты считается осуществление Заказчиком конклюдентных действий: согласование даты и времени получения информационной услуги (запись на услугу), внесения оплаты за Услуги. Акцепт настоящей Оферты означает, в том числе, предоставление Заказчиком согласия на обработку персональных данных.</p>
    <p>Договор считается заключенным в письменной форме на основании положений п. 3 ст. 434, п. 3 ст. 438 ГК РФ (письменная форма договора считается соблюденной, если письменное предложение заключить договор принято путем акцепта, совершенного конклюдентными действиями).</p>
    <p>Договор заключается в каждом случае обращения Заказчика за Услугами.</p>
    <p>Срок действия настоящей оферты устанавливается с 01.07.2026 года до момента ее официального отзыва или утверждения предложения (оферты) в новой редакции.</p>
    <p>Настоящая Оферта может быть в любое время в одностороннем порядке изменена Исполнителем. Такие изменения приобретают силу для Сторон только с момента её размещения на сайте Исполнителя.</p>
    <p><B>ДОГОВОР ОКАЗАНИЯ ПЛАТНЫХ ИНФОРМАЦИОННЫХ УСЛУГ</B></p>
    <p><B>1. ПОНЯТИЯ, ИСПОЛЬЗУЕМЫЕ В НАСТОЯЩЕМ ДОГОВОРЕ</B></p>
    <p><B>1. Термины и определения</B></p>
    <p>Термины, используемые в рамках настоящего Договора-оферты (далее — «Договор»), имеют определения согласно настоящему разделу, а при отсутствии соответствующего термина с определением в настоящем разделе — согласно законодательству Российской Федерации, при отсутствии — толкованию в словарях.</p>
    <p>1.1. Сайт — сайт Исполнителя в информационно-телекоммуникационной сети «Интернет» по адресу <L href="https://radiology-arts.ru">https://radiology-arts.ru</L> (и их поддомены), на котором доступно приобретение доступа к Услугам и сопутствующим материалам Исполнителя.</p>
    <p>1.2. Стороны — Заказчик и Исполнитель при их совместном упоминании, а Сторона — любое из них при упоминании по отдельности.</p>
    <p>1.3. Сделка — договор, заключенный между Заказчиком и Исполнителем с использованием Сайта на условиях, изложенных в Договоре.</p>
    <p>1.4. Материалы — аудиовизуальные произведения, текстовые произведения, обучающие материалы к Услуге, в том числе дополнительные (Бонусные) материалы, опубликованные Исполнителем на Сайте в информационно-телекоммуникационной сети «Интернет».</p>
    <p>1.5. Тариф – стоимость, наполнение и период оказания Услуги, которые определяются на Сайте.</p>
    <p>1.6. Оферта – договор возмездного оказания информационных услуг между Исполнителем и Заказчиком, который заключается посредством акцепта оферты, совершенного конклюдентными действиями: согласование даты и времени получения информационной услуги (регистрация на услугу), внесения оплаты (часть оплаты) за Услуги. Договор заключается в целях получения Заказчиком информационных услуг, а также получения иных сопутствующих услуг и материалов и пр. (совместно именуемые – «услуги»). Договор считается заключенным в письменной форме на основании положений п. 3 ст. 434, п. 3 ст. 438 ГК РФ.</p>
    <p>1.7. Услуги – информационно-консультационные услуги по запросам Заказчика, оказываемые в режиме онлайн- и офлайн-сопровождения, в том числе:</p>
    <p>- анализ представленных Заказчиком результатов диагностических и лабораторных обследований с помощью открытых источников данных, включающие в себя источники сети «Интернет», научные публикации и литературу;<br/>- предоставление информации по лекарственным средствам и препаратам, на основании открытых информационных источников данных;<br/>- видео-презентации обучающие, развивающие, познавательные программы, практические тренинги, интенсивы, курсы, марафоны, гайды, информационное сопровождение с комментариями и разъяснениями Исполнителя и/или привлеченного им лица.<br/>- услуги по наставничеству.</p>
    <p>1.9. Заказчик — физическое лицо, которому оказываются Услуги в соответствии с настоящим Договором.</p>
    <p>1.10. Исполнитель – физическое лицо Попов Алексей Юрьевич (далее – Исполнитель).</p>
    <p>1.11. Первичное обращение – первичное обращение Заказчика с целью получения Услуг.</p>
    <p>1.12. Повторное обращение – повторное обращение Заказчика с целью получения иных и/или новых услуг по ранее полученным у Исполнителя услугам, после принятия первичных услуг Заказчиком, в соответствии с п. 3.11. настоящего Договора.</p>
    <p>1.13. Онлайн сопровождение – оказание услуг, дистанционно с использованием телефонной, видеоконференцсвязи по предоставлению дополнительных разъяснений, консультаций, дополнительной информации по ранее предоставленным услугам.</p>
    <p>1.14. Офлайн сопровождение – оказание информационно-консультационных услуг, осуществление просветительской деятельности посредством участия в конференциях, чтения лекций, участия в бизнес-завтраках и т.д.</p>
    <p>1.15. ГК РФ — Гражданский кодекс Российской Федерации (части I, II, III, IV).</p>
    <p><B>2. ПРЕДМЕТ ДОГОВОРА</B></p>
    <p>2.1. Исполнитель на основании обращения Заказчика обязуется оказать ему информационно-консультационные услуги, а Заказчик обязуется оплатить Услуги до момента их получения в полном объеме, принять оказанные Услуги в соответствии с условиями настоящего Договора.</p>
    <p>2.2. Стоимость услуг и период их оказания отражен на Сайте. Действующая стоимость выбранной Заказчиком Услуги, согласно прейскуранту, цен и тарифов, отражённых при регистрации на Услугу. Заказчик вправе выбрать разовые услуги, онлайн-сопровождение в течение срока, предложенного Исполнителем в необходимом объеме.</p>
    <p>2.3. Исполнитель оказывает Услуги лично, по выбору Заказчика либо дистанционно с использованием согласованного сторонами.</p>
    <p><B>3. УСЛОВИЯ И ПОРЯДОК ОКАЗАНИЯ УСЛУГ</B></p>
    <p>3.1. На условиях Договора Исполнитель оказывает информационно-консультационные услуги и информационное сопровождение Заказчику, а также предоставляет различные информационные материалы на условиях простой (неисключительной) лицензии.</p>
    <p>3.2. Право на просмотр и/или прослушивание материалов и получение услуг доступны только для Заказчика, совершившего оплату, соответствующего Тарифа.</p>
    <p>3.3. После регистрации на Услугу Заказчик заполняет анкету (информационный лист, Приложение № 1 для пациентов или Приложение №2 для врачей, формы которых являются неотъемлемой частью настоящего Договора), вносит 100%-тную предоплату в размере, указанном на Сайте, после чего в согласованные даты, Исполнитель связывается с Заказчиком через выбранный сервис.</p>
    <p>3.4. Заказчик оплачивает Услуги в соответствии с п.4.3. настоящей оферты.</p>
    <p>3.5. Исполнитель оказывает услуги как лично, так и с привлечением третьих лиц. Оказание Услуг происходит при условии их предоплаты в полном объеме. Исполнитель вправе приостановить оказание услуг до их полной оплаты.</p>
    <p>3.6. Исполнитель несет ответственность за последствия неисполнения или ненадлежащего исполнения обязательств привлеченным Третьим лицом.</p>
    <p>3.7. Исполнитель гарантирует, что имеются все необходимые разрешения на оказание Услуг, которые будут оказаны Третьим лицом.</p>
    <p>3.8. При оказании Услуг Исполнитель информирует Заказчика о том, что он не вправе ставить и/или корректировать диагнозы, а также назначать и/или корректировать лечение, прописанное врачом, либо иным лицом.</p>
    <p>3.9. Заказчик до или во время оказания Услуги задает Исполнителю уточняющие вопросы по выбранному тарифу и Услугам.</p>
    <p>3.10. По итогам оказания услуги Заказчику может быть направлен информационный материал.</p>
    <p>3.11. Услуги считаются оказанными Исполнителем надлежащим образом, в полном объеме и принятыми Заказчиком, если в течение 3 (трех) дней с момента оказания услуги, Исполнителем не получены от Заказчика мотивированных письменных возражений относительно качества, срока и объема оказанных услуг.</p>
    <p>3.12. Никакие претензии Заказчика относительно качества и объёма оказанных Услуг не принимаются, если Заказчик не направил мотивированных письменных возражений относительно качества и объема оказанных услуг в соответствии с п.3.11. настоящей оферты.</p>
    <p>3.13. В случае, когда Исполнитель пытается связаться с Заказчиком в согласованные Сторонами дату и время по средствам выбранного средства для связи, а Заказчик не отвечает, Исполнитель в течение следующих 10 (десяти) минут пытается повторно связаться с Заказчиком. В случае, если по прошествии 3 (трех) суток Заказчик не выходит на связь и не согласует новую дату и время оказания услуги, Услуга считается оказанной Исполнителем и принятой Заказчиком, подлежит оплате в размере 100 %.</p>
    <p>3.14. Никакие претензии Заказчика относительно сроков оказания Услуг не принимаются, если Заказчик не согласует дату и время на оказание Услуг, в соответствии с п.3.3. настоящей оферты или не будет находиться в системе (онлайн) после согласования.</p>
    <p>3.15. В случае, если после отправки согласования даты и времени оказания Услуги Заказчик захочет отказаться от оказания Услуг, он обязан уведомить об этом Исполнителя в сроки и порядке п.7.1. Договора, Исполнитель возвращает Заказчику всю сумму, оплаченную Заказчиком, в том числе обязательный платёж, в порядке и сроки согласно п. 7.5. Договора.</p>
    <p>3.16. В случае, если после отправки согласования даты и времени оказания Услуги Заказчик захочет отказаться от оказания Услуг, но не уведомил об этом Исполнителя в порядке и сроки, согласно п.7.1. Договора, Исполнитель вправе не возвращать платёж Заказчику, что будет являться оплатой подготовительных мер и усилий, предпринятых Исполнителем для оказания услуг в полном объёме.</p>
    <p><B>4. СТОИМОСТЬ УСЛУГ И ПОРЯДОК ОПЛАТЫ</B></p>
    <p>4.1. Услуги оказываются Заказчику за плату при условии их приобретения Заказчиком. Стоимость Услуги указывается на Сайте при регистрации на Услуги и в соответствии с Тарифом.</p>
    <p>4.2. Стоимость Услуг включает вознаграждение, расходы и издержки Исполнителя, связанные с оказанием Услуг.</p>
    <p>4.3. Заказчик оплачивает Услуги Исполнителя в полном объеме в следующем порядке:<br/>- путём внесения авансового платежа в размере 100 % от стоимости услуг, на расчётный счет Исполнителя, до оказания услуги;<br/>- путем поэтапной оплаты на расчетный счет Исполнителя (порядок согласовывается индивидуально с Заказчиком посредством мессенджеров).</p>
    <p>4.4. Услуга считается оплаченной в момент зачисления денежных средств на счет Исполнителя.</p>
    <p>4.5. Заказчик согласен получать документ, подтверждающий оплату Услуг Исполнителя, в момент расчета за Услуги, по номеру телефона в мессенджере, указанном при регистрации на Услугу, либо по указанной при регистрации электронной почте.</p>
    <p>4.6. Цена материалов и услуг на Сайте может быть изменена Исполнителем в одностороннем порядке. При этом цена на оплаченные ранее Услуги изменению не подлежит.</p>
    <p><B>5. ИНЫЕ ПРАВА И ОБЯЗАННОСТИ СТОРОН</B></p>
    <p>5.1. Исполнитель обязуется:<br/>5.1.1. Обеспечить Заказчика доступной и достоверной информацией по вопросам, связанным с оказанием Услуг и иным вопросам, относящимся к предмету настоящего Договора.<br/>5.1.2. Предоставить выбранные и оплаченные Заказчиком услуги и материалы по выбранному Тарифу;<br/>5.1.3. Уважительно и гуманно относиться к Заказчику.<br/>5.1.4. Обеспечить режим конфиденциальности в соответствии с действующим законодательством РФ.<br/>5.1.5. Не разглашать информацию о персональных данных Заказчика без его согласия и осуществлять их обработку исключительно с целью исполнения настоящего Договора в соответствии с Политикой конфиденциальности, утвержденной Исполнителем;<br/>5.1.6. По мере возможности информировать (предупреждать) Заказчика о дополнительных условиях и предстоящих изменениях в порядке оказания Услуг и предоставлении материалов путем размещения соответствующей информации на Сайте и/или письмом на адрес электронной почты Заказчика, указанный при оплате услуг и материалов.<br/>5.1.7. Выполнять иные обязанности в соответствии с настоящим Договором.</p>
    <p>5.2. Исполнитель имеет право:<br/>5.2.1. Получать от Заказчика любую информацию, необходимую для выполнения своих обязательств по настоящему Договору.<br/>5.2.2. Получать вознаграждение за оказание Услуг по настоящему Договору.<br/>5.2.3. Направить в адрес Заказчика в электронном виде информационный материал, по теме предоставления услуг.</p>
    <p>5.3. Заказчик обязуется:<br/>5.3.1. Принимать информацию, которую предоставляет Исполнитель во время оказания Услуг.<br/>5.3.2. Оплачивать Услуги в порядке, в сроки и на условиях, которые установлены настоящим Договором.<br/>5.3.3. Соблюдать правила оказания Услуг и правила пользования сервисами, сайтом. Обеспечить условия конфиденциальности в момент оказания Услуги.<br/>5.3.4. Выполнять иные обязанности в соответствии с настоящим Договором.</p>
    <p>5.4. Заказчик имеет право:<br/>5.4.1. Получать от Исполнителя услуги в соответствии с настоящим Договором.<br/>5.4.2. Задавать уточняющие вопросы во время получения Услуги.</p>
    <p><B>6. КОНФИДЕНЦИАЛЬНОСТЬ</B></p>
    <p>6.1. Исполнитель обязуется хранить в тайне информацию о факте обращения Заказчика за услугой, в соответствии с настоящим Договором.</p>
    <p>6.2. Заказчик уведомлен и осознает, что Услуги могут оказываться по открытым каналам связи и что данные каналы не гарантируют соблюдения режима конфиденциальности передаваемой информации.</p>
    <p>6.3. Стороны обязуются хранить в тайне финансовую и иную конфиденциальную информацию, полученную от другой Стороны при исполнении настоящего Договора.</p>
    <p><B>7. ПОРЯДОК ВОЗВРАТА ОПЛАТЫ</B></p>
    <p>7.1. Заявления о возврате денежных средств за услуги, срок оказания которых не наступил, должны быть поданы не позднее, чем за 1 (один) календарный день до начала оказания Услуг.</p>
    <p>7.2. Все заявления о возврате денежных средств принимаются только в письменном виде. Для отправки такого заявления Заказчику необходимо его собственноручно заполнить, поставить свою личную подпись, отсканировать и отправить документ (в формате PDF или JPEG) Исполнителю по контактным данным, указанным на Сайте и/или в настоящем Договоре.</p>
    <p>7.3. Информация, которая обязательно должна содержаться в заявлении на возврат денежных средств:<br/>— наименование адресата и данные заявителя;<br/>— сумма оплаты услуг и/или материалов;<br/>— причины, побудившие вернуть деньги;<br/>— реквизиты для перевода денежных средств;<br/>— приложения;<br/>— дата, подпись, расшифровка подписи.</p>
    <p>7.4. К заявлению о возврате денежных средств должны быть приложены копия документа, удостоверяющего личность заявителя, скрин платежного документа, свидетельствующего об оплате (в формате PDF или JPEG).</p>
    <p>7.5. Возврат денежных средств производится Исполнителем в течение 10 (десяти) дней, после получения соответствующего письменного заявления, путём безналичного перечисления по реквизитам, указанным в требовании Заказчика, в соответствии с условиями Договора.</p>
    <p>7.6. Возврат денежных средств за услугу, которая оказана Исполнителем и принята Заказчиком, в соответствии с п. 3.11. настоящего Договора, возврату не подлежит. Настоящие правила также применяются к п 3.13. настоящего Договора.</p>
    <p>7.7. В случае получения заявления о возврате денежных средств, предъявленного Заказчиком позже срока, установленного п. 7.1. настоящего Договора, или заявления о возврате денежных средств за Услуги, которые оказаны Пользователю или оказаны частично, Исполнитель рассматривает его с учетом следующих правил:<br/>- при наличии претензий к объему и качеству предоставляемых услуг, Исполнитель рассматривает заявление о возврате при наличии письменных доказательств того, что соответствующая услуга, входящая в приобретенный Тариф Услуги, не была оказана или была оказана ненадлежащим образом, или материалы не предоставлены по вине Исполнителя;<br/>- в случае установления факта неоказания услуг или оказании услуг ненадлежащего качества или не предоставления материалов Исполнитель осуществляет возврат денежных средств за вычетом фактически понесенных им расходов;<br/>- если заявление о возврате обусловлено желанием Заказчика прервать оказание Услуги, а виновные действия со стороны Исполнителя отсутствуют, то возврат денежных средств осуществляется за вычетом затрат за фактически оказанные услуги и/или приобретенные материалы/прав на материалы.</p>
    <p>7.8. Решение о возврате или об отказе в возврате денежных средств принимается Исполнителем в течение 10 (десяти) дней с момента получения соответствующего заявления Заказчика.</p>
    <p>7.9. Денежные средства возвращаются на счет Пользователя, с которого производилась оплата, в течение 14 (четырнадцати) рабочих дней после принятия решения о возврате.</p>
    <p>7.10. Возврат денежных средств за услугу, приобретенную с помощью кредитного продукта (рассрочка, кредит и иные, относящиеся к данной категории), осуществляется за вычетом процентов, уплаченных банку Исполнителем, по сумме выплаченного основного долга на момент получения заявления о возврате денежных средств. Проценты за предоставление/пользование кредитным продуктом оплачиваются Заказчиком самостоятельно.</p>
    <p><B>8. ОТВЕТСТВЕННОСТЬ СТОРОН</B></p>
    <p>8.1. Исполнитель несет ответственность перед Заказчиком за неисполнение или ненадлежащее исполнение условий настоящего Договора.</p>
    <p>8.2. Исполнитель не несет ответственности за действия/бездействия Заказчика при оказании услуг, а именно за результат, на который рассчитывает Заказчик, если при этом он полностью/частично не соблюдает требований и рекомендаций, полученных от Исполнителя в ходе оказания услуг.</p>
    <p>8.3. Ни одна из Сторон не будет нести ответственности за полное или частичное неисполнение другой Стороной своих обязанностей, если неисполнение будет являться следствием обстоятельств непреодолимой силы, таких, как пожар, наводнение, землетрясение, забастовки и другие стихийные бедствия, война и военные действия или другие обстоятельства, находящиеся вне контроля Сторон, препятствующие выполнению настоящего Договора, возникшие после заключения Договора, а также по иным основаниям, предусмотренным законом.<br/>Если любое из таких обстоятельств непосредственно повлияло на неисполнение обязательства в срок, указанный в Договоре, то этот срок соразмерно отодвигается на время действия соответствующего обстоятельства.<br/>Сторона, для которой сделалось невозможным исполнение обязательств по Договору, обязана не позднее 3 (трех) дней с момента их наступления и прекращения в письменной форме уведомить другую Сторону о наступлении, предполагаемом сроке действия и прекращении вышеуказанных обстоятельств.</p>
    <p><B>9. ИНЫЕ УСЛОВИЯ</B></p>
    <p>9.1. Настоящий Договор является публичным договором, его форма расположена на сайте по указанной ссылке <L href="https://radiology-arts.ru">https://radiology-arts.ru</L> для ознакомления неограниченного круга лиц.</p>
    <p>9.2. Настоящий Договор заключен в порядке, описанном в преамбуле оферты о его заключении.</p>
    <p>9.3. Настоящий Договор заключается на неопределенный срок. Заказчик вправе расторгнуть настоящий Договор, письменно уведомив Исполнителя не менее чем за 10 (десять) календарных дней до предполагаемой даты расторжения.</p>
    <p>9.4. В случае если какое-либо из условий Договора являются по какой-либо причине недействительным, такая недействительность не оказывает влияния на действительность остальных условий Договора, которые остаются в силе.</p>
    <p>9.5. Все дополнительные соглашения Сторон, акты и иные приложения к настоящему Договору являются его неотъемлемой частью.</p>
    <p>9.6. Все споры, претензии и разногласия, которые могут возникнуть между Сторонами, будут разрешаться путем переговоров. Направления письменных претензий друг другу, срок рассмотрения которых составляет 10 рабочих дней.</p>
    <p>9.7. При неурегулировании в процессе переговоров спорных вопросов споры подлежат рассмотрению в судебном порядке в соответствии с нормами действующего законодательства РФ.</p>
    <p><B>10. АДРЕС И РЕКВИЗИТЫ ИСПОЛНИТЕЛЯ</B></p>
    <p>Попов Алексей Юрьевич<br/>ИНН 644101988643<br/>Адрес для направления корреспонденции: 396335, а/я 7<br/>Р/с 40817810700133616471 в АО «Т-Банк»<br/>БИК 044525974<br/>Корр. счет 30101810145250000974<br/>Контактный телефон <L href="tel:+79155835045">+79155835045</L><br/>Адрес электронной почты: <L href="mailto:brainmodel@yandex.ru">brainmodel@yandex.ru</L></p>
  </div>
);

const DOCS: Record<string, { title: string; content: string; jsx?: React.ReactNode }> = {
  offer: {
  ...
  videos: [
    {
      ...
      link: '',
      price: '999 ₽',
      buyLink: 'https://radiologyart.getcourse.ru/video_anatom_verh',
      active: true,
      bundleLinks: [
        'Плечевой сустав',
        'Локтевой сустав',
...
const SERVICES = [
  ...
  { icon: "FileSearch", title: "Телерадиология", desc: "Дистанционная работа с готовыми исследованиями. Удобный формат сотрудничества.", links: [{ label: "info", tooltip: "Прейскурант Эвкалипт", href: "https://www.evkaliptmed.ru/services/mrt/" }, { label: "info", tooltip: "Прейскурант Smart Clinic", href: "https://smart-clinica.ru/staff/vrachi/popov-aleksey-yurevich/?sphrase_id=193893" }, { label: "info", tooltip: "Прейскурант АНО ДПО ИПКМК", href: "https://univerexpert.ru/telemedicine/" }] },
  { icon: "BookOpen", title: "Обучение", desc: "Формирование структурированной теоретической базы у начинающих врачей-рентгенологов. Лектор семинаров НМО.", links: [{ label: "info", tooltip: "Курсы Практической радиологии", href: "https://practicalradiology.ru/all_curs" }, { label: "info", tooltip: "Прейскурант ИПКМК", href: "https://univerexpert.ru/courses/" }] },
];
