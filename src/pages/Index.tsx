...
const SERVICES = [
  ...
  { icon: "FileSearch", title: "Телерадиология", desc: "Дистанционная работа с готовыми исследованиями. Удобный формат сотрудничества.", links: [{ label: "info", tooltip: "Прейскурант Smart Clinic", href: "https://smart-clinica.ru/staff/vrachi/popov-aleksey-yurevich/?sphrase_id=193893" }, { label: "info", tooltip: "Прейскурант АНО ДПО ИПКМК", href: "https://univerexpert.ru/telemedicine/" }] },
